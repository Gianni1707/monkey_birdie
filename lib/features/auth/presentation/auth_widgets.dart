...
/// Selettore lingua compatto (globo + codice) per le schermate di accesso.
/// Collegato al cambio lingua globale già esistente (`localeControllerProvider`):
/// Automatico (segue il sistema) · Italiano · English. Stessa fonte di verità
/// del selettore nelle Impostazioni profilo.
class SelettoreLingua extends ConsumerWidget {
  const SelettoreLingua({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final etichetta = switch (code) { 'it' => 'IT', 'en' => 'EN', _ => 'AUTO' };
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(etichetta, style: Theme.of(context).textTheme.labelLarge),
          ],
        ),
      ),
    );

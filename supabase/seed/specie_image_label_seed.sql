...
--  964 specie riconoscibili dal modello immagine AIY Birds V1. Le label AIY
--  SONO nomi scientifici, quindi image_label = nome_scientifico per le specie in
--  catalogo. Generato da assets/labels/aiy_birds_labels.csv
--  (tool/genera_seed_image_label.dart). Eseguire dopo 0004_specie_image_label.sql.
-- =====================================================================
